...
namespace Shop.Controllers
{
    public class CartController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            // Складываем сумму и записываем во ViewBag, если корзина не пуста
            decimal total = 0m;
        ...
        public ActionResult AddToCartPartial(int id)
        {
            ...
            using (Db db = new Db())
            {
                ...
                // Если нет, то добавляем этот товар в корзину
                ...
                // Если находится, то добавляем единицу товара
                else
                {
        ...
        public void PlaceOrder()
        {
            ...
            {
                Credentials = new NetworkCredential("c730e153033779", "6cbb5cd071c4e8"),
                EnableSsl = true
            };
            client.Send("FPS@example.com", "admin@example.com", "New Order", $"You have a new order. Order number: {orderId}");
